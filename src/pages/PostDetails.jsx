    ...
    <>
      ...
      {!isLoading &&
        <>
          ...
          <section className="container mt-5" id="card-view-post">
            <section className="row g-2 py-lg-2">


              <aside className="left-aside col-12 col-md-1 col-lg-1 p-0 sticky-sm-bottom">
                <div className="left-aside__div d-flex justify-content-around d-md-block d-lg-block object-fit-contain sticky-md-top pt-md-5">
                  ...
                  <button type="button" className="left-aside btn d-lg-block mx-0 my-1 p-0"><img className="dots rounded-circle p-2"
              ...
              <main className=" col-12 col-lg-8 col-md-11 my-md-4 ">
                <section className="">
                  <div className="card ">

...
const CreateAccount = () => {
    ...
    const customSubmit = ( async (data) => { 
        ...
        try {
            ...
            await localStorage.setItem('token', userLoggined.token);
            window.open( '/','_self');
          } catch (error) {
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="d-grid text text-center mb-2">
                            ...
                            <p className="card-text text-center mt-4 fs-6"><small>Already have an account? <a href="#"> Log in.</a></small></p>
                            ...
                            <form onSubmit={ handleSubmit(customSubmit) } id="signup-form">
                                ...
                                <div className="d-grid gap-2 text text-center">
                                    <button className="btn btn-primary py-2" type="submit" id="signup_button">Continue</button>
